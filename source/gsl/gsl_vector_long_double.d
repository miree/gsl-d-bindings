/* Converted to D from gsl_vector_long_double.h by htod
 * and edited by daniel truemper <truemped.dsource <with> hence22.org>
 */
module gsl.gsl_vector_long_double;
...
public import gsl.gsl_block_long_double;
...
alias _gsl_vector_long_double_const_view gsl_vector_long_double_const_view;
...
_gsl_vector_long_double_const_view  gsl_vector_long_double_const_view_array(real *v, size_t n);

_gsl_vector_long_double_const_view  gsl_vector_long_double_const_view_array_with_stride(real *base, size_t stride, size_t n);
...
_gsl_vector_long_double_const_view  gsl_vector_long_double_const_subvector(gsl_vector_long_double *v, size_t i, size_t n);

_gsl_vector_long_double_const_view  gsl_vector_long_double_const_subvector_with_stride(gsl_vector_long_double *v, size_t i, size_t stride, size_t n);

/* Operations */

real  gsl_vector_long_double_get(gsl_vector_long_double *v, size_t i);
...
real * gsl_vector_long_double_const_ptr(gsl_vector_long_double *v, size_t i);
...
int  gsl_vector_long_double_fwrite(FILE *stream, gsl_vector_long_double *v);

int  gsl_vector_long_double_fscanf(FILE *stream, gsl_vector_long_double *v);

int  gsl_vector_long_double_fprintf(FILE *stream, gsl_vector_long_double *v, char *format);

int  gsl_vector_long_double_memcpy(gsl_vector_long_double *dest, gsl_vector_long_double *src);
...
real  gsl_vector_long_double_max(gsl_vector_long_double *v);

real  gsl_vector_long_double_min(gsl_vector_long_double *v);

void  gsl_vector_long_double_minmax(gsl_vector_long_double *v, real *min_out, real *max_out);

size_t  gsl_vector_long_double_max_index(gsl_vector_long_double *v);

size_t  gsl_vector_long_double_min_index(gsl_vector_long_double *v);

void  gsl_vector_long_double_minmax_index(gsl_vector_long_double *v, size_t *imin, size_t *imax);

int  gsl_vector_long_double_add(gsl_vector_long_double *a, gsl_vector_long_double *b);

int  gsl_vector_long_double_sub(gsl_vector_long_double *a, gsl_vector_long_double *b);

int  gsl_vector_long_double_mul(gsl_vector_long_double *a, gsl_vector_long_double *b);

int  gsl_vector_long_double_div(gsl_vector_long_double *a, gsl_vector_long_double *b);
