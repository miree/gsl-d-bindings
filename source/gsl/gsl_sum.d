/* Converted to D from gsl_sum.h by htod
...
int  gsl_sum_levin_u_accel(double *array, size_t n, gsl_sum_levin_u_workspace *w, double *sum_accel, double *abserr);
...
int  gsl_sum_levin_u_minmax(double *array, size_t n, size_t min_terms, size_t max_terms, gsl_sum_levin_u_workspace *w, double *sum_accel, double *abserr);
...
int  gsl_sum_levin_utrunc_accel(double *array, size_t n, gsl_sum_levin_utrunc_workspace *w, double *sum_accel, double *abserr_trunc);

int  gsl_sum_levin_utrunc_minmax(double *array, size_t n, size_t min_terms, size_t max_terms, gsl_sum_levin_utrunc_workspace *w, double *sum_accel, double *abserr_trunc);
